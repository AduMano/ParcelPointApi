...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=Desktop-0GLFD43;Database=ParcelPointDb;Integrated Security=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ParcelLog>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasDefaultValueSql("(newid())");
            entity.Property(e => e.Action).UseCollation("Latin1_General_CI_AS");
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.LockerNumber).UseCollation("Latin1_General_CI_AS");
            entity.Property(e => e.ParcelName).UseCollation("Latin1_General_CI_AS");
            entity.Property(e => e.Status).UseCollation("Latin1_General_CI_AS");
        });
        ...
        modelBuilder.Entity<UserInformation>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasDefaultValueSql("(newid())");
            entity.Property(e => e.ContactNumber).UseCollation("Latin1_General_CI_AS");
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(getdate())");
            ...
            entity.Property(e => e.LastName).UseCollation("Latin1_General_CI_AS");
            entity.Property(e => e.MiddleName).UseCollation("Latin1_General_CI_AS");
            entity.Property(e => e.ModifiedAt).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.Suffix).UseCollation("Latin1_General_CI_AS");
        ...
        modelBuilder.Entity<UserbioFp>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasDefaultValueSql("(newid())");
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.FingerprintKey).UseCollation("Latin1_General_CI_AS");
            entity.Property(e => e.ModifiedAt).HasDefaultValueSql("(getdate())");
        });
